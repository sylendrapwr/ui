...
import styles from './ProductionPage.css';
...
function ProductionPage(props) {
  ...
  function getCardData() {
    const consumption = useData && useData['e-production'];
  ...
  async function updateChart(startTime, endTime) {
    ...
    await getChartData('production', token, sendStart, sendEnd)
    ...
    <div className="container">
      <div className="row">
        <div className="col-12 mb-1">
          <p className={styles.title}>ENERGY PRODUCTION</p>
        </div>
        <div className="col-8">
          <CardComponent>
            <GlobalChart
